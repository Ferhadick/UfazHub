...
from app.services.collections import create_collection, get_collection, list_collections, update_collection, vote_collection
...
async def index(
    ...
    items, total = await list_collections(session, limit, offset)
